    ...
    <body>
        ...
        <div class="select-preferences-con">
            <form method="POST" action="preview.php">
                ...
                <input class="address" type="text" name="destination" id="search" placeholder="Enter name of the destination" required>
                <p class="date-con">Enter dates</p>
                <label>Start:</label>
                <input class="date-start" type="date" name="dateStart" ><br>
                <label>End :</label>
                <input class="date-end" type="date" name="dateEnd"><br>
