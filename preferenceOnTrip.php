...
<html>
    ...
    <body>
        ...
        <div class="select-preferences-con">
            <form method="POST" action="preview3.php">
                ...
                <textarea style="width:400px;height:200px;" name="description" placeholder="Enter any specific activities(if any) you are willing to do in the trip"></textarea><br>
